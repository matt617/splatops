...
Config.Defenses = {
	AutoTurret = {
		...
		Price = 175,
		CardImage = "rbxassetid://78413175617048",
		IconImage = "rbxassetid://112098923904671", -- placement tool hotbar icon
		Health = 50,
		DamagePerSecond = 1,
		RangeStuds = 40,
		LifetimeSeconds = 60,
	...
	DeployableWall = {
		...
		Price = 75,
		CardImage = "rbxassetid://70805478438305",
		IconImage = "rbxassetid://105046533595337", -- placement tool hotbar icon
		Health = 100,
		LifetimeSeconds = 45,
	...
	PersonalShield = {
		...
		Price = 100,
		CardImage = "rbxassetid://132839444332425",
		BlocksHits = 1,
		DurationSeconds = 30,
	},
}
...
Config.Utility = {
	SpeedBoost = {
		...
		Price = 50,
		CardImage = "rbxassetid://74730871557689",
	...
	DoubleJump = {
		...
		Price = 100,
		CardImage = "rbxassetid://126149044917703",
		Persists = "MATCH",
	},
	ScoutDrone = {
		...
		Price = 125,
		CardImage = "rbxassetid://126503322576285",
